...
export const postUpdateCategoryById = async ({ id, ...params }: PostUpdateCategoryByIdRequest) => {
  return apiClient.post(`${ PREFIX }/update/${ id }`, params).then<void>(responseHandler);
};
